...
@implementation GZComposeTextView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [GZNotificationCenter addObserver:self selector:@selector(textDidChange) name:UITextViewTextDidChangeNotification object:self];
    }
    return self;
}
